        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <?php  
                  ...
                  <li class="page-item"><a class="page-link" href="category.php?cid=<?php echo $cat_id; ?>&page=<?php echo ($page-1)?>">Previous</a>
                  </li>
                  ...
                  <li class="page-item"><a class="page-link" href="category.php?cid=<?php echo $cat_id; ?>&page=<?php echo $i?>"><?php echo $i?></a>
                  </li>
                  <?php  
                  }
                  ...
                  <li class="page-item"><a class="page-link" href="category.php?cid=<?php echo $cat_id; ?>&page=<?php echo ($page+1)?>">Next</a>
                  </li>
